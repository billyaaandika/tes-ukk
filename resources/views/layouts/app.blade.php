...
<head>
    ...
    <title>
        Uji Kompetensi Test - @yield('title')
    </title>
    <!--     Fonts and icons     -->
    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-radius-lg fixed-start ms-2  bg-white my-2" id="sidenav-main">
        <div class="sidenav-header">
            ...
            <a class="navbar-brand px-4 py-3 m-0" href=" https://demos.creative-tim.com/material-dashboard/pages/dashboard " target="_blank">
                ...
                <span class="ms-1 text-sm text-dark">UKK Tes</span>
            </a>
        </div>
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link text-dark {{ request()->routeIs('admin.dashboard') ? 'active' : 'text-dark' }}"
                ...
                <li class="nav-item">
                    <a class="nav-link text-dark {{ request()->routeIs('admin.users.index') ? 'active' : 'text-dark' }}"
                ...
                <li class="nav-item">
                    <a class="nav-link text-dark {{ request()->routeIs('admin.category.index') ? 'active' : 'text-dark' }}"
                ...
                <li class="nav-item">
                    <a class="nav-link text-dark {{ request()->routeIs('admin.tools.index') ? 'active' : 'text-dark' }}"
                        href="{{ route('admin.tools.index') }}">
                        <div class="icon icon-shape icon-sm border-radius-md text-center me-2">
                            <i class="ni ni-tv-2 text-dark opacity-10"></i> <!-- dashboard icon -->
                        </div>
                        <span class="nav-link-text ms-1">Kelola Alat</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-dark {{ request()->routeIs('admin.borrowings.index') ? 'active' : 'text-dark' }}"
                ...
                <li class="nav-item">
                    <a class="nav-link text-dark {{ request()->routeIs('admin.returns.index') ? 'active' : 'text-dark' }}"
                        href="{{ route('admin.returns.index') }}">
                        <div class="icon icon-shape icon-sm border-radius-md text-center me-2">
                            <i class="ni ni-tv-2 text-dark opacity-10"></i> <!-- dashboard icon -->
                        </div>
                        <span class="nav-link-text ms-1">Kelola Pengembalian</span>
                    </a>
                </li>
                @endif
                ...
                <li class="nav-item">
                    <a class="nav-link text-dark {{ request()->routeIs('officer.dashboard') ? 'active' : 'text-dark' }}"
                ...
                <li class="nav-item">
                    <a class="nav-link text-dark {{ request()->routeIs('officer.borrowings.index') ? 'active' : 'text-dark' }}"
                        href="{{ route('officer.borrowings.index') }}">
                        <div class="icon icon-shape icon-sm border-radius-md text-center me-2">
                            <i class="ni ni-tv-2 text-dark opacity-10"></i> <!-- dashboard icon -->
                        </div>
                ...
                <li class="nav-item mt-2 sidenav-footer position-absolute w-100 bottom-0 ">
                    <form action="{{ route('logout') }}" method="POST">
                        ...
                        <div class="row justify-content-center">
                            <button type="submit"
                                class="btn w-80 px-2 py-2 bg-gradient-danger text-white border-0"
